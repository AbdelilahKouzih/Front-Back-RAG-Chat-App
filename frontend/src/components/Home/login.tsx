...
const SignIn: React.FC<SignInProps> = ({ onClose }) => { // Use SignInProps interface here
    return (
      ...
      <button onClick={onClose} className="mt-4 px-4 py-2 bg-blue-500 text-white rounded hover:bg-blue-600 focus:outline-none focus:bg-blue-600">Close</button> {/* Example close button */}
