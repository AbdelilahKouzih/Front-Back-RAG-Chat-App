    ...
    >
      <div className="flex items-center px-5 lg:px-7.5 xl:px-10 max-lg:py-4">
        ...
        <button
          ...
          className={`group cursor-pointer relative cursor-default w-[120px] h-[40px] bg-[linear-gradient(144deg,_#af40ff,_#5b42f3_50%,_#00ddeb)] text-white whitespace-nowrap flex flex-wrap rounded-lg overflow-hidden ${
            openNavigation ? 'hidden' : ''
          } button-responsive`}
        >
          <span className="absolute left-1/2 top-1/2 -translate-x-1/2 -translate-y-1/2 z-10 pointer-events-none font-code">
            Let's Chat
          </span>
