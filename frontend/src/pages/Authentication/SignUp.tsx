...
const SignUp: React.FC<SignUpProps> = (props) => {
  ...
  // Fonctions pour mettre à jour les états des champs
      ...
      try {
        ...
        const response = await fetch('http://localhost:5000/api/user/register', {
          ...
          body: JSON.stringify({
            fullName,
            email,
            password, // Envoyer le mot de passe hashé
            confirmPassword,
          }),
        });
        ...
        <div className="w-full p-4 sm:p-12.5 xl:p-2.5">
          ...
          <form onSubmit={handleSubmit}>
            <div className="mb-4">
              <div className="relative">
                <input
                  ...
                  } bg-transparent py-4 pl-6 pr-10 text-white outline-none focus:border-primary focus-visible:shadow-none dark:border-form-strokedark dark:bg-form-input dark:text-white dark:focus:border-primary`}
                />
                {errors.fullName && (
            ...
            <div className="mb-4">
              <div className="relative">
                <input
                  ...
                  value={email}
                  onChange={handleEmailChange} // Ajoutez cette ligne
                  className={`w-full rounded-lg border ${
            ...
            <div className="mb-4">
              <div className="relative">
                <input
                  ...
                  value={password}
                  onChange={handlePasswordChange} // Ajoutez cette ligne
                  className={`w-full rounded-lg border ${
            ...
            <div className="mb-6">
              <div className="relative">
                <input
                  ...
                  onChange={handleConfirmPasswordChange} // Ajoutez cette ligne
                  className={`w-full rounded-lg border ${
            ...
            <p className="text-center text-white dark:text-white">
              ...
              <button onClick={handleSwitchToSignIn} className="text-primary">
                Sign In
              </button>
            </p>
          </form>
